...
/*********** 
 * Zadanie 5: Policz ile miejsca powinna zajmować zmienna typu `samochod`.
 ...
 * 
 * Okazuje się, że zamieniając kolejność pól w strukturze możemy zamienić jej rozmiar. 
...
struct samochod {
    // Możesz zmieniać kolejność pól w strukturze
